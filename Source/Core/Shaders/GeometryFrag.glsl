...
void main()
{
	...
	vec3 Albedo = Whiteworld ? vec3(1.0f) : (u_UsesAlbedoTexture ? (u_CatmullRom ? CatmullRom(u_AlbedoMap, v_TexCoords, LODBias).xyz : texture(u_AlbedoMap, v_TexCoords, LODBias).xyz) : u_ModelColor);
